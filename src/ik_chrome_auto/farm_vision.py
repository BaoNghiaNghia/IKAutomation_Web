...
class FarmTemplateId(StrEnum):
    ...
    BROWSER_RESOURCE_LEVEL_6 = "browser_resource_level_6"
    BROWSER_RESOURCE_LEVEL_7 = "browser_resource_level_7"
    BROWSER_SEARCH_TARGET_CHECKBOX_UNCHECKED = "browser_search_target_checkbox_unchecked"
    BROWSER_SEARCH_TARGET_CHECKBOX_CHECKED = "browser_search_target_checkbox_checked"
